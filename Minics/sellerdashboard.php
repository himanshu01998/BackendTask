...
if ($_SESSION['email'] == '') {
    ...
    $sql = "SELECT * FROM `seller` WHERE seller_email = '$session_email';";
...
?>
    ...
    <body>
        ...
        <div class="hero_area">
            ...
            <?php
            echo "<br><h2 class='w-40 mx-auto'> Welcome to Minics, ", $row['seller_name'], "</h2>";
            $sqlcat = "SELECT * FROM `category`";
            $querycat = mysqli_query($conn, $sqlcat);
            ?>
            <div class="container">
                <div class="seller-cat">
                    <div class="row mt-5 px-5 mx-auto">
                        <?php
                        while ($rowcat = mysqli_fetch_array($querycat)) {
                            $cat_name = $rowcat['category_name'];
                            $cat_table = $rowcat['category_table'];
                            $cat_image = $rowcat['category_image'];

                            echo "<div class=col>";
                            echo "<a href=sellerproduct.php?category=$cat_table>";
                            echo "<img src=$cat_image height=250 width=250>";
                            echo "<h3 class=mt-2>$cat_name</h3>";
                            echo "</a>";
                            echo "</div>";
                        }
                        ?>
