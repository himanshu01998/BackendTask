...
if ($_SESSION['email'] == '') {
    ...
    $cat = $_SESSION['cat'];
    $sqlshow = "SELECT * FROM $cat WHERE product_id = $prod_id;";
    $queryshow = mysqli_query($conn, $sqlshow) or die("Error in show query");
...
?>
    ...
    <body>
        ...
        <div class="hero_area">
            ...
            <div class="container">
    <h2 class="mt-5 mx-auto w-25">Update Product</h2>
        <form method="post" enctype="multipart/form-data">
            <div class="row mt-5">
                <div class="col">
                    <div class="mb-3">
                        <label for="prod_name" class="form-label">Product Name</label>
                        <input type="text" class="form-control" value="<?php echo $rowshow['product_name']; ?>" name="prod_name" aria-describedby="emailHelp">
                    </div>
                </div>
                <div class="col">
                    <div class="mb-3">
                        <label for="prod_cat" class="form-label">Product Category</label><br>
                        <select name="cat" id="cat-select" class="categories w-100 p-2">
            ...
            <div class="row mt-3">
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="<?php echo $rowshow['product_sub_category']; ?>" name="prod_subcat" aria-describedby="emailHelp">
                    </div>
                </div>
                <div class="col">
                    <div class="mb-3">
                        <label for="prod_price" class="form-label">Product Price</label>
                        <input type="text" class="form-control" value="<?php echo $rowshow['product_price']; ?>" name="prod_price" aria-describedby="emailHelp">
                    </div>
                </div>
                <div class="col">
                    <div class="mb-3">
                        <label for="prod_color" class="form-label">Product Color</label>
                        <input type="text" class="form-control" value="<?php echo $rowshow['product_color']; ?>" name="prod_color" aria-describedby="emailHelp">
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-3">
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="<?php echo $rowshow['product_desc']; ?>" name="prod_desc" aria-describedby="emailHelp">
                    </div>
                </div>
            </div>
        ...
        $old_filepath = $rowshow['product_img1'];
        ...
        if(isset($_POST['add'])){
            ...
            $sql = "UPDATE $product_category SET product_name = '$product_name', product_sub_category = '$product_subcategory', product_price = '$product_price', product_color = '$product_color', product_desc = '$product_desc', product_img1 = '$filepath' WHERE product_id=$prod_id";
            echo $sql;
        ...
        <script>
            document.getElementById("cat-select").value="<?php echo $cat; ?>";
        </script>
